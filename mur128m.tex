...
mul2f reg1, reg2, imm10          & $\texttt{reg1}\leftarrow \texttt{reg2}\cdot2^{\texttt{imm10}}$. Здесь reg1 и reg2 --- вещественные регистры, а imm10 --- знаковая целочисленная 10--разрядная константа. \\ \hline 
chsf reg1, reg2                  & $\texttt{reg1}\leftarrow-\texttt{reg2}$\\ \hline
\end{longtable}    
...
absf reg1, reg2                 & 01:0000001010:reg1:reg2:0000000000 (т.е. используется шаблон D с $\texttt{T}=01$, $\texttt{OP}=0000001010$, $\texttt{R1}=\texttt{reg1}$, $\texttt{R2}=\texttt{reg2}$) \\ \hline
mul2f reg1, reg2, reg3          & 01:0000001011:reg1:reg2:reg3:00000 (т.е. используется шаблон F с $\texttt{T}=01$, $\texttt{OP}=0000001011$, $\texttt{R1}=\texttt{reg1}$, $\texttt{R2}=\texttt{reg2}$, $\texttt{R3}=\texttt{reg3}$) \\ \hline
mul2f reg1, reg2, imm10         & 01:0000001011:reg1:reg2:imm10:00000 (т.е. используется шаблон E с $\texttt{T}=01$, $\texttt{OP}=0000001100$, $\texttt{R1}=\texttt{reg1}$, $\texttt{R2}=\texttt{reg2}$, $\texttt{IMM}=\texttt{imm10}$) \\ \hline
chsf reg1, reg2                 & 01:0000000101:reg1:reg2:0000000000 (т.е. используется шаблон D с $\texttt{T}=01$, $\texttt{OP}=0000001101$, $\texttt{R1}=\texttt{reg1}$, $\texttt{R2}=\texttt{reg2}$) \\ \hline
\end{longtable} 
